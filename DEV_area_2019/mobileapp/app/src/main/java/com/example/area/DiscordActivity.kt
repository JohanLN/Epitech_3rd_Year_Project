...
/**
 * Class DiscordActivity. Activity class, where the user can sign to the Discord service and set all Actions Reactions settings.
 */

class DiscordActivity : AppCompatActivity() {


    private var oauth : OAuth? = null
    private var users : OAuthUser? = null

    private val provider = "discord"

    private var loginBouton : TextView? = null
    private var logoutBouton : TextView? = null

    private val TAG = "DiscordActivity"
    ...
    /**
     * Display the activity, allows the user to sign to the Discord service and to set Actions Reactions settings.
     */
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        loginBouton = findViewById(R.id.login_button_ds)
        logoutBouton = findViewById(R.id.logout_button_ds)
        ...
        loginBouton?.setOnClickListener {
            oauth!!.popup(provider, OAuthCallback {
                ...
                //////// ACCESS TOKEN ////////
                data -> Log.w(TAG, data.token)
                updateUI(true)
                Toast.makeText(this@DiscordActivity, "You are sign in !", Toast.LENGTH_SHORT).show()
                ApiRequest().registerService("Discord",data.token, progressBar, applicationContext)
            })
        }
        logoutBouton?.setOnClickListener {
            updateUI(false)
            Toast.makeText(this@DiscordActivity, "You are sign out !", Toast.LENGTH_SHORT).show()
        }
    }
    ...
    private fun initialize() {
        progressBar = findViewById(R.id.DsProgress)
